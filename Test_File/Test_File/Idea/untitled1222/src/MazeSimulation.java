...
/*
import model.se.umu.cs.c19jem.essentials.Maze;
import model.se.umu.cs.c19jem.robots.MemoryRobot;
import model.se.umu.cs.c19jem.essentials.Position;
import model.se.umu.cs.c19jem.robots.RandomRobot;
import model.se.umu.cs.c19jem.robots.RightHandRuleRobot;
import model.se.umu.cs.c19jem.essentials.Robot;
*/
...
public class MazeSimulation {
    ...
    protected void loadMaze() {
        ...
        do {
            ...
            try {
                ...
                maze=(new Maze(new FileReader("file.txt")));
    ...
    public void runSimulation(Robot r) {
        ...
        if(r.hasReachedGoal())
            updateMessage("se.umu.cs.c19jem.essentials.Robot reached goal after "+i+" steps");
        else
            updateMessage("se.umu.cs.c19jem.essentials.Robot did not reach goal before reaching maximum number of steps");
    }
